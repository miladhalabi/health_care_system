      ...
      <div className="w-full max-w-[440px] z-10">
        <Card className="p-10 lg:p-14 border-border-main shadow-premium">
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h2 className="text-2xl font-black text-content leading-tight">بوابة السجل الوطني</h2>
            <p className="text-[11px] font-bold text-content-muted mt-2 uppercase tracking-[0.2em]">نظام المعلومات الصحية المتطور</p>
          </div>
          ...
          <div className="mt-12 text-center opacity-50">
             <p className="text-[9px] text-content-muted font-black uppercase tracking-[0.3em]">الجمهورية العربية السورية - وزارة الصحة</p>
          </div>
        </Card>
      </div>
    </div>
